...
import com.tencent.kuikly.compose.material3.OutlinedTextFieldDefaults.Container
...
import com.tencent.kuikly.compose.material3.tokens.FilledTextFieldTokens
import com.tencent.kuikly.compose.material3.tokens.OutlinedTextFieldTokens
...
object TextFieldDefaults {
     ...
     *
     * @sample com.tencent.kuikly.compose.material3.samples.CustomTextFieldBasedOnDecorationBox
     *
    ...
    fun DecorationBox(
        ...
        container: @Composable () -> Unit = {
            Container(
                ...
                colors = colors,
                shape = shape,
                focusedBorderThickness = FocusedIndicatorThickness,
                unfocusedBorderThickness = UnfocusedIndicatorThickness,
            )
        },
    ) {
        CommonDecorationBox(
    ...
    @Deprecated(
        ...
        replaceWith =
            ReplaceWith(
                ...
                "com.tencent.kuikly.compose.material.OutlinedTextFieldDefaults",
            ),
        level = DeprecationLevel.WARNING,
    )
...
object OutlinedTextFieldDefaults {
     ...
     * An example of building a custom text field using [DecorationBox]:
     *
     * @sample com.tencent.kuikly.compose.material3.samples.CustomOutlinedTextFieldBasedOnDecorationBox
     *
     * @param value the input [String] shown by the text field
     * @param innerTextField input text field that this decoration box wraps. You will pass here a
     *   framework-controlled composable parameter "innerTextField" from the decorationBox lambda of
...
class TextFieldColors
    constructor(
        ...
        internal fun TextSelectionColors?.takeOrElse(block: () -> TextSelectionColors): TextSelectionColors = this ?: block()
         ...
         */
        @Stable
        internal fun cursorColor(isError: Boolean): Color = if (isError) errorCursorColor else cursorColor
